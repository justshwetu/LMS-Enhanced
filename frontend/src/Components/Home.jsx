...
function Home() {
  ...
  return (
    <div>
      ...
      <div>
        <section id="home">
          <h2>Enhance your future with Chitkara Edu</h2>
          <p>
            {" "}
            Chitkara Edu is a massive open online course provider, and its
            learning experience arranges coursework into a series of modules and
            lessons that can include videos and assessment tests.
          </p>
          <div className="btn">
        ...
        <section id="features">
          ...
          <div className="fea-base">
            <div className="fea-box">
              ...
              <h3>Test Facility</h3>
              <p>Originality is the essence of true assessment. </p>
            </div>
            <div className="fea-box">
